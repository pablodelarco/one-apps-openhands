...
# Build 2: Provision the OpenHands QCOW2 image
...
build {
  ...
  # Step 5: Install OpenHands appliance script
  provisioner "file" {
    source      = "../../appliances/openhands/appliance.sh"
  ...
  # Step 7: Run service_install (installs Docker, Caddy, pre-pulls images)
  provisioner "shell" {
    inline_shebang = "/bin/bash -e"
